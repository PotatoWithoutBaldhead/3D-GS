...
def render(viewpoint_cameras, pc : GaussianModel, pipe, bg_color: torch.Tensor, scaling_modifier = 1.0, override_color = None, rasterizer = None):
    ...
    rendered_image, radii, visibility_filter, p_view= rasterizer(
        means3D = means3D,
        shs = shs,
